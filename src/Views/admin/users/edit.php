    ...
    <form method="POST" action="/admin/usuarios/<?= $user['id'] ?>/editar" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" id="name" name="name"
               ...
               class="w-full px-3 py-2.5 text-sm border rounded-xl bg-white focus:outline-none focus:ring-2
                      <?= isset($errors['name']) ? 'border-red-400 focus:ring-red-200' : 'border-warm-200 focus:ring-brand-200' ?>">
      ...
      <div>
        ...
        <select id="role" name="role"
                class="w-full px-3 py-2.5 text-sm border rounded-xl bg-white focus:outline-none focus:ring-2
                       <?= isset($errors['role']) ? 'border-red-400 focus:ring-red-200' : 'border-warm-200 focus:ring-brand-200' ?>">
      ...
      <div class="flex items-center justify-between pt-2">
        ...
        <button type="submit"
                ...
                onmouseover="this.style.background='#162E4A'"
                onmouseout="this.style.background='#0F1E2E'">
