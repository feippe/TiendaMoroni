...
<div class="flex items-center justify-between mb-6">
  ...
  <a href="/admin/productos/nuevo"
     class="px-4 py-2 bg-brand-700 text-white text-sm font-semibold rounded-xl hover:bg-brand-800 transition">
    + Nuevo producto
  </a>
</div>
...
<form method="get" class="mb-4 flex gap-2">
  <input type="text" name="q" value="<?= e($q) ?>" placeholder="Buscar por nombre..."
         class="flex-1 border border-warm-300 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 transition">
  <button type="submit"
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="divide-y divide-warm-100">
        ...
        <tr class="hover:bg-warm-50 transition">
          ...
          <td class="px-4 py-3 font-medium text-warm-900 max-w-[200px] truncate"><?= e($p['name']) ?></td>
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-2">
              <a href="/admin/productos/<?= (int)$p['id'] ?>/editar"
                 class="text-brand-700 hover:text-brand-900 transition text-xs font-medium">Editar</a>
