    ...
    <div class="bg-brand-800 text-warm-50 rounded-2xl p-8 text-center shadow-xl">
      <div class="flex justify-center mb-5">
        <div class="bg-brand-400/20 rounded-full p-4">
          <i data-lucide="mail" class="w-10 h-10" style="color:var(--color-gold)"></i>
        </div>
      </div>
...
<?php else: ?>
    ...
    <!-- Google OAuth -->
    <a href="/auth/google" aria-label="Registrate con Google"
      ...
      <span aria-hidden="true">Registrate con Google</span>
    </a>
    ...
    <form method="post" action="/auth/register" class="space-y-4">
      ...
      <div>
        <label for="reg-name" class="block text-sm font-medium text-warm-700 mb-1">Nombre completo</label>
      ...
      <div>
        <label for="reg-email" class="block text-sm font-medium text-warm-700 mb-1">Email</label>
        <input id="reg-email" type="email" name="email" required autocomplete="email"
               class="w-full border border-warm-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold transition">
      </div>
      <div>
        <label for="reg-password" class="block text-sm font-medium text-warm-700 mb-1">Contraseña (mín. 8 caracteres)</label>
        <input id="reg-password" type="password" name="password" required minlength="8"
               class="w-full border border-warm-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold transition">
      </div>
      <div>
        <label for="reg-password-confirm" class="block text-sm font-medium text-warm-700 mb-1">Confirmá la contraseña</label>
        <input id="reg-password-confirm" type="password" name="password_confirm" required minlength="8"
               class="w-full border border-warm-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold transition">
      </div>
